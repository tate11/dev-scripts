...
if __name__ == '__main__':
    ...
    parser.add_argument('-u', '--update-database', action='store', nargs=1 , help="Update database requires -d and -m option")
    parser.add_argument('-d', '--database', dest='database', action='append', help="Database to update")
    parser.add_argument('-m', '--module', dest='module', action='append', help="Module to update or all, you can specify multiple -m options")
